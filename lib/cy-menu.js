...
const He = (e, t) => e === t, Ke = Symbol("solid-track"), z = {
  equals: He
};
let ge = $e;
const K = 1, D = 2, ye = {
...
function _e(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(s, t)) && (e.value = t, e.observers && e.observers.length && J(() => {
    for (let l = 0; l < e.observers.length; l += 1) {
      ...
      u && U.disposed.has(i), (u && !i.tState || !u && !i.state) && (i.pure ? S.push(i) : O.push(i), i.observers && we(i)), u || (i.state = K);
    }
    if (S.length > 1e6)
      throw S = [], new Error();
  }, !1)), t;
...
function te(e, t) {
  ...
  for (let s = 0; s < e.sources.length; s += 1) {
    const l = e.sources[s];
    l.sources && (l.state === K || n ? l !== t && ee(l) : (l.state === D || n) && te(l, t));
  }
}
function we(e) {
  const t = U;
...
function Ze(e, t, n = {}) {
  ...
  return Ue(() => he(i)), () => {
    let c = e() || [], f, r;
    return c[Ke], W(() => {
      let a = c.length, v, g, p, L, A, x, P, N, d;
      if (a === 0)
        ...
        for (p = new Array(a), L = new Array(a), o && (A = new Array(a)), x = 0, P = Math.min(u, a); x < P && s[x] === c[x]; x++)
          ;
        for (P = u - 1, N = a - 1; P >= x && N >= x && s[P] === c[N]; P--, N--)
          p[N] = l[P], L[N] = i[P], o && (A[N] = o[P]);
        for (v = /* @__PURE__ */ new Map(), g = new Array(N + 1), r = N; r >= x; r--)
          d = c[r], f = v.get(d), g[r] = f === void 0 ? -1 : f, v.set(d, r);
        for (f = x; f <= P; f++)
          d = s[f], r = v.get(d), r !== void 0 && r !== -1 ? (p[r] = l[f], L[r] = i[f], o && (A[r] = o[f]), r = g[r], v.set(d, r)) : i[f]();
        for (r = x; r < a; r++)
          r in p ? (l[r] = p[r], i[r] = L[r], o && (o[r] = A[r], o[r](r))) : l[r] = Z(y);
...
function et(e, t, n, s = {}) {
  let l;
  return Z((i) => {
    l = i, t === document ? e() : M(t, e(), t.firstChild ? null : void 0, n);
  }, s.owner), () => {
    l(), t.textContent = "";
  };
}
...
function ne(e, t, n, s, l) {
  ...
  if (e = u && n[0] && n[0].parentNode || e, i === "string" || i === "number") {
    ...
    if (i === "number" && (t = t.toString()), u) {
      let o = n[0];
      o && o.nodeType === 3 ? o.data = t : o = document.createTextNode(t), n = V(e, n, s, o);
    } else
    ...
    if (Array.isArray(t)) {
      ...
      if (o.length === 0) {
        ...
        c ? n.length === 0 ? pe(e, o, s) : De(e, n, o) : (n && V(e), pe(e, o));
      n = o;
...
function ot(e) {
  const [t, n] = m(e.slots.headerSlot || null), [s, l] = m(e.slots.footerSlot || null), [i, u] = m(e.slots.menuSlot || null), [o, c] = m(e.slots.menuIconSlot || null), [f, r] = m(e.props.activeMenu || null), [y, a] = m([]), [v, g] = m(e.props.footerHeight || "0"), [p, L] = m({}), [A, x] = m(e.props.expand || !0), [P, N] = m(e.props.unique || !0), [d, _] = m(e.props.data || []), [h, $] = m(e.props.labelProp || "label"), [C, H] = m(e.props.keyProp || "key"), [R, T] = m(e.props.childProp || "children"), [Y, Me] = m(e.props.openKeys || []), [Ne, de] = m([]), [Le, ke] = m(e.props.height || "100%"), [Ie, Te] = m(e.props.width || "240px"), [Oe, Be] = m(e.props.alwaysPopover || !1);
  _(() => [...re(d(), 0, R(), C())]);
  const F = {
    headerSlot: {
      value: t,
  ...
  return Object.keys(F).forEach((E) => {
    if (F[E] instanceof Object) {
      const G = E.slice(0, 1).toLocaleUpperCase() + E.slice(1);
      e.methods[`update${G}`] = F[E].change, e.methods[`get${G}`] = F[E].value;
    }
  }), Re(() => {
    const E = Y(), G = Pe(F.data.value(), E, C(), R());
    de(() => G);
  }), j(Ce.Provider, {
    value: F,
    get children() {
...
const it = /* @__PURE__ */ k('<div class="cy-menu-item-popover"></div>'), rt = /* @__PURE__ */ k('<div class="cy-menu-popover-arrow"></div>'), ut = /* @__PURE__ */ k('<div class="cy-menu-popover-content"></div>'), ct = /* @__PURE__ */ k('<div class="cy-menu-popover-name"></div>'), at = (e) => {
...
}, le = (e) => typeof e != "number" ? e : `${e}px`, ft = /* @__PURE__ */ k("<li><div></div></li>"), dt = /* @__PURE__ */ k('<div class="cy-menu-item-icon"></div>'), ht = /* @__PURE__ */ k('<div class="cy-menu-item-label"></div>'), vt = /* @__PURE__ */ k('<div class="cy-menu-item-arrow"><svg width="100%" height="100%" viewBox="0 0 48 48" fill="none"><path d="M19 12L31 24L19 36" stroke="#787878" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></div>'), pt = /* @__PURE__ */ k("<div></div>"), gt = (e) => {
  const {
    expand: t,
    unique: n,
    openKeys: s,
  ...
  let p = null;
  const L = (d) => {
    if (v(d), g || (u.change(() => u.value() instanceof Object ? d : d[o.value()]), i.change(() => d.parentKeyList)), !g || e.isPopover)
      return;
    const _ = {
      ...d,
      level: e.level
    ...
    if (n.value()) {
      const H = l.value().find((T) => T[o.value()] === h), R = l.value().findIndex((T) => T.level === e.level);
      if (H) {
    ...
    const $ = s.value(), C = $.findIndex((H) => H === h);
    C > -1 ? $.splice(C, 1) : $.push(h), s.change(() => [...$]);
  }, A = (d) => {
    const _ = d[o.value()];
    return s.value().findIndex((C) => C === _) > -1;
  }, x = (d, _) => {
    !N(d) || (p.changePopover(d), p.setMouseEvent(_, d ? "enter" : "leave"));
  }, P = (d) => {
  ...
  return (() => {
    ...
    return _.addEventListener("mouseleave", (h) => x(!1, h)), _.addEventListener("mouseenter", (h) => x(!0, h)), _.$$click = () => L(e.data), M(_, (() => {
      const h = q(() => !!r.value());
      return () => h() ? se(r.value())(e.data) : [(() => {
        ...
        return M($, () => e.data[c.value()]), $;
      })(), g ? vt.cloneNode(!0) : []];
    })()), M(d, g ? (() => {
      const h = pt.cloneNode(!0);
      return M(h, j(fe, {
        get list() {
      ...
      const $ = `cy-menu-item ${A(e.data) ? "cy-menu-item-expand" : ""} ${P(e.data) ? "cy-menu-item-active" : ""}`, C = e.level, H = `cy-menu-item-box  ${A(e.data) ? "cy-menu-item-box-expand" : ""}`;
      return $ !== h._v$ && Q(d, h._v$ = $), C !== h._v$2 && Se(d, "data-level", h._v$2 = C), H !== h._v$3 && Q(_, h._v$3 = H), h;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0
...
const yt = /* @__PURE__ */ k("<ul></ul>"), fe = (e) => (() => {
  ...
  return (() => {
    ...
    return typeof y == "function" ? Ae(y, c) : o = c, M(
      f,
      () => se(e.value())("header")
    ), M(c, j(fe, {
      isContent: !0,
      ...
      const v = `cy-menu cy-menu-container ${n.value() ? "cy-menu-expand" : "cy-menu-shrink"} cy-menu-theme-blue`, g = l.value(), p = i.value(), L = u.value();
      return v !== a._v$ && Q(c, a._v$ = v), g !== a._v$2 && c.style.setProperty("--cy-menu-height", a._v$2 = g), p !== a._v$3 && c.style.setProperty("--cy-menu-width", a._v$3 = p), L !== a._v$4 && c.style.setProperty("--cy-menu-footer-height", a._v$4 = L), a;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
